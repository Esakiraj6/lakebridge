...
from databricks.labs.lakebridge.config import TranspileConfig, ReconcileConfig, LakebridgeConfigs
...
class ApplicationContext:
    ...
    def product_info(self) -> ProductInfo:
        return ProductInfo.from_class(LakebridgeConfigs)
    ...
    @cached_property
    def remorph_config(self) -> LakebridgeConfigs:
        return LakebridgeConfigs(transpile=self.transpile_config, reconcile=self.recon_config)
