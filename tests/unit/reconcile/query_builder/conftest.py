...
from conftest import oracle_schema_fixture_factory, ansi_schema_fixture_factory
...
@pytest.fixture
def normalized_table_conf_with_opts_snowflake(normalize_config_service: NormalizeReconConfigService, table_conf_with_opts):
